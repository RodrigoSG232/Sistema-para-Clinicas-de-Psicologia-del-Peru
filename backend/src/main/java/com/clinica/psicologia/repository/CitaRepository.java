...
public interface CitaRepository extends JpaRepository<Cita, Integer> {
    ...
    @Query("SELECT c FROM Cita c LEFT JOIN FETCH c.especialidad LEFT JOIN FETCH c.psicologo LEFT JOIN FETCH c.paciente WHERE c.paciente.id = :pacienteId ORDER BY c.creadoEn DESC")
    List<Cita> findByPacienteIdOrderByCreadoEnDesc(@Param("pacienteId") Integer pacienteId);
